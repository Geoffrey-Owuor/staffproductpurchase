...
const LoadingLine = () => {
  ...
  return (
    <>
      {isLoading && (
        <motion.div
          className="fixed top-0 right-0 left-0 z-9999 h-[3px] bg-linear-to-br from-rose-500 via-rose-600 to-rose-700 dark:from-sky-400 dark:via-blue-400 dark:to-indigo-400"
