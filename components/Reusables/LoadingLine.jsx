...
const LoadingLine = () => {
  ...
  return (
    <>
      {isLoading && (
        <motion.div
          className="fixed top-0 right-0 left-0 z-9999 h-0.5 bg-linear-to-r from-sky-500 via-blue-500 to-indigo-500 dark:from-sky-400 dark:via-blue-400 dark:to-indigo-400"
