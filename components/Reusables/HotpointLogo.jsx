...
export default function HotpointLogo({ isOpen }) {
  return (
    <div className="flex items-center gap-0.5">
      ...
      <span
        className={`overflow-hidden text-2xl font-bold whitespace-nowrap text-gray-900 ${isOpen ? "custom:w-30" : "custom:w-0"} transition-all duration-200 dark:text-white`}
      >
