const generateStaffHrApprovedEmailHTML = ({
  staffName,
  payrollNo,
  hr_approver_name,
  products,
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background: #fcfcfc; border-top: 5px solid #B71C1C; border-radius: 8px; max-width: 600px; margin: 0 auto;">
                  <tr>
                    <td style="padding: 25px;">
                      <h1 style="color: #B71C1C; font-size: 24px; text-align: center; margin: 0 0 15px 0;">Purchase Request Approved by HR</h1>
                      ...
                      <p style="color: #555555; font-size: 15px;">Your Purchase Request has been approved by HR</p>
...
export default generateStaffHrApprovedEmailHTML;
