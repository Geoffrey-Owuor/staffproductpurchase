const generateStaffCCApprovedEmailHTML = ({
  staffName,
  payrollNo,
  cc_approver_name,
  products,
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background: #fcfcfc; border-top: 5px solid #B71C1C; border-radius: 8px; max-width: 600px; margin: 0 auto;">
                  <tr>
                    <td style="padding: 25px;">
                      <h1 style="color: #B71C1C; font-size: 24px; text-align: center; margin: 0 0 15px 0;">Purchase Request Approved by Credit Control</h1>
                      <p style="background: #ffebee; color: #B71C1C; text-align: center; padding: 10px; font-weight: bold; border-radius: 4px;">Status: Hr approved, Credit Control Approved, (Pending Billing & Invoice)</p>
                      <p style="color: #555555; font-size: 15px;">Your Purchase Request has been approved by Credit Control</p>
                      <h3 style="color: #333;">Details</h3>
                         ...
                         <p><strong>Credit Control Approval Date:</strong> ${new Date().toLocaleDateString("en-GB")}</p>
...
export default generateStaffCCApprovedEmailHTML;
