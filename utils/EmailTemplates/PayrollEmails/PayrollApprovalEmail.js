const generatePayrollApprovalEmailHTML = ({
  staffName,
  payrollNo,
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background: #fcfcfc; border-top: 5px solid #B71C1C; border-radius: 8px; max-width: 600px; margin: 0 auto;">
                  <tr>
                    <td style="padding: 25px;">
                      ...
                      <p style="color: #555555; font-size: 15px;">A new purchase request approved by Payroll awaits your review and approval.</p>
...
export default generatePayrollApprovalEmailHTML;
