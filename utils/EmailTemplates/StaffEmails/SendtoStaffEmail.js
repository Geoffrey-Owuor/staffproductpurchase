//Sending email to staff after purchase submission
const generateUserPurchaseEmailHTML = ({ staffInfo, products }) => {
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background: #fcfcfc; border-top: 5px solid #B71C1C; border-radius: 8px; max-width: 600px; margin: 0 auto;">
                  <tr>
                    <td style="padding: 25px;">
                      ...
                      <p style="color: #555555; font-size: 15px;">You will be updated as the request goes through various approval stages</p>
...
export default generateUserPurchaseEmailHTML;
