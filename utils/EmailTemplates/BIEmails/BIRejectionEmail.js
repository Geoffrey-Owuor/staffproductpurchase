const generateBIRejectionEmailHTML = ({
  staffName,
  payrollNo,
  bi_approver_name,
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background: #fcfcfc; border-top: 5px solid #B71C1C; border-radius: 8px; max-width: 600px; margin: 0 auto;">
                  <tr>
                    <td style="padding: 25px;">
                      <h1 style="color: #B71C1C; font-size: 24px; text-align: center; margin: 0 0 15px 0;">Purchase Request Declined by Billing & Invoice</h1>
                      <p style="background: #ffebee; color: #B71C1C; text-align: center; padding: 10px; font-weight: bold; border-radius: 4px;">Status: Billing & Invoice Declined</p>
                      <p style="color: #555555; font-size: 15px;">We regret to inform you that your purchase request has been <strong>declined</strong> by Billing & Invoice.</p>
                      ...
                      <p style="color: #555555; font-size: 15px;">Please contact Billing & Invoice if you have any questions or wish to discuss this decision.</p>
                      </div>
                    </td>
                  </tr>
                </table>
...
export default generateBIRejectionEmailHTML;
