...
//           alt="Company Logo"
//           style="display: block; margin: 0 auto; max-height: 80px; margin-top: -37px;"
//         />
//       </div>
...
//               <tr>
//                 <td style="padding: 8px 0; border-bottom: 1px solid #F3F4F6; font-size: 14px; color: #6B7280;">Amount</td>
//                 <td style="padding: 8px 0; border-bottom: 1px solid #F3F4F6; font-size: 14px; font-weight: 500; text-align: right;">${formatCurrency(purchase.amount)}</td>
//               </tr>
//               <tr>
//                 <td style="padding: 8px 0; font-size: 14px; color: #6B7280;">Approval Time</td>
//                 <td style="padding: 8px 0; font-size: 14px; font-weight: 500; text-align: right;">${calculateDaysDifference(purchase.createdAt, purchase.bi_approval_date)}</td>
//               </tr>
//             </table>
//           </div>
//         </div>
