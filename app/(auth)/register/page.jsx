...
//   //Load step from local storage on first render
//   useEffect(() => {
...
//   //Save step and email to local storage whenever they change
//   useEffect(() => {
...
//       //Determine which dashboard path to go to based on role
//       let dashboardPath;
...
//       //redirect based on dashboard path
//       window.location.href = dashboardPath;
//     } catch (err) {
//       setError(err.message);
//     }
...
//         {success && (
//           <div className="mb-4 text-center text-green-700">{success}</div>
//         )}
