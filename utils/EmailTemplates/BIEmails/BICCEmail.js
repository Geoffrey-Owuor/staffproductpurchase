  ...
  return `
    ...
    <html>
      <head>
        ...
        <title>Invoicing Approved, Close Request</title>
        <!--[if mso]>
          <style>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background: #fcfcfc; border-top: 5px solid #B71C1C; border-radius: 8px; max-width: 600px; margin: 0 auto;">
                  <tr>
                    <td style="padding: 25px;">
                      <h1 style="color: #4CAF50; font-size: 24px; text-align: center; margin: 0 0 15px 0;">Request Approved By Invoicing, Close Request</h1>
                       ...
                       <p style="color: #555555; font-size: 15px;">Purchase request has been approved by Invoicing, You can now <strong>Close</strong> the request</p>
...
export default generateBICCApprovedEmailHTML;
